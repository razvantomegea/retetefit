...
4. If local raw images are provided, run `corepack pnpm recipe:prepare-images --input "<raw-image-dir>" --slug "<slug>"`.
5. Create the Romanian and English recipe markdown files.
6. Verify paths, pricing, dates, and image output.
7. Commit and push unless the user asks you not to.
